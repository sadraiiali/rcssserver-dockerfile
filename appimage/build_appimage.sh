...
set -e
apt purge -y flex
apt-get update && DEBIAN_FRONTEND="noninteractive" apt-get install -y tzdata gcc g++ wget flex bison libboost-all-dev automake make cmake iputils-ping build-essential libtool 
